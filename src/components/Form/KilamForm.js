...
export default function KilamForm() {
  return (
    <form className="p-4 bg-orange-200 m-2 rounded-md">
    ...
    <div className="flex h-16 shrink-0 items-center justify-between font-extrabold ">
                <label
                  ...
                  className=" grid grid-colblock text-sm font-medium leading-6 text-gray-900 sm:pt-1.5 px-10"
                >
       ...
       <div className="h-full w-[.15px] bg-gray-400 bg-opacity-9 "/>
                ...
                <label
                  ...
                  className="grid grid-cols-1block text-sm font-medium leading-6 text-gray-900 sm:pt-1.5 px-10"
                >
                 ...
                 <div className="flex justify-center ">
                    ...
                    <label
                  htmlFor="Information Systems Department"
                  className="block text-sm leading-6 text-gray-900 sm:pt-1.5 font-extrabold"
                >
          ...
          <div className="borde ">
            {/* <div className="mt-10 space-y-8 border-b border-gray-900/10 pb-12 sm:space-y-0 sm:divide-y sm:divide-gray-900/10 sm:border-t sm:pb-0"> */}
              <div className="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
                ...
                >
                  Requirements Description and Background (Attach separate page
                  if required)
                </label>
 ...
 <div className="h-[.15px] w-full bg-gray-400 bg-opacity-9 "/>
              ...
              <div className="sm:grid sm:grid-cols-3 sm:items-center sm:gap-4 sm:py-6">
                ...
                >
                  Functional Approval Date & Reference No (Only for New &
                  Existing Process Change)
                </label>
                <div className="mt-2 sm:col-span-2 sm:mt-0">
                  <input
 ...
 <div className="h-[.15px] w-full bg-gray-400 bg-opacity-9 "/>
    ...
    <div className="sm:flex flex-col sm:items-start sm:gap-4 sm:py-6">
            ...
            {/* <div className="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
              <label
                htmlFor="Requestor to confirm the following: -"
                className="block text-sm font-medium leading-6 text-gray-900 sm:pt-1.5"
              >
                Requestor to confirm the following: -
              </label>
              <div className="relative flex gap-x-3">
                <div className="flex h-6 items-center">
                  <input
                ...
                <div className="text-sm leading-6">
                  <label htmlFor="" className="font-medium text-gray-900">
                    In case of New Requirement/Existing Process change, Approval
                    has been obtained from CGM/ED and attached with Request
                    Form.
                  </label>
                </div>
              </div>
              <div className="relative flex gap-x-3">
                ...
                <div className="text-sm leading-6">
                  <label htmlFor="" className="font-medium text-gray-900">
                    In case of Bug Fix, Document is attached with Scenarios in
                    production/Quality Landscape.
                  </label>
                </div>
              </div>
            </div> */}
  ...
  <div className="borde border-gray-400 border-2 rounded-lg p-2" >
        ...
        <div className="flex flex-col space-y-3">
          ...
          <div className="sm:gri sm:grid-cols-3 sm:items-start sm:gap-4 sm:py- w-full">
            {/* <label
                  ...
                  className="block text-sm font-medium leading-6 text-gray-900 sm:pt-1.5"
                  ></label> */}
            <div className="mt-2 sm:col-span-2 sm:mt-0 py- h-20">
              <input
                type="Date"
        ...
        <div className="flex flex-col space-y-3">
          <div className="sm: flex flex-col sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-">
            <label
              htmlFor="Requested by(Business User)"
              className="block text-sm font-medium leading-6 text-gray-900 sm:pt-6"
              >
              Approved by
              (Location-In-Charge)
            </label>
    ...
    <div className="borde border-gray-400 border-2 rounded-lg p-2">
        ...
        {/* <div className="h-[.15px] w-full bg-gray-300 bg-opacity-9"/>   */}
    <div className="borde border-gray-400 border-2 rounded-lg p-2">
         <div className="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
          <label
            htmlFor="Reviewed by"
